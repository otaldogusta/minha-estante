...
content = content.replace('normBool(v.privado) !== normBool(i.privado)', 'normBool(v.privado) !== normBool(i.privado) || normStr(v.arquivo_url) !== normStr(i.arquivo_url)')
content = content.replace('privado: !!v.privado,', 'privado: !!v.privado,\n            arquivo_url: v.arquivo_url || null,')
...
print("Patched formulario-livro")
