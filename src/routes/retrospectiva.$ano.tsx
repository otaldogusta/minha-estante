  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`flex items-center gap-2 font-medium text-xs sm:text-sm text-amora transition-all duration-300 ease-out ${
            hovered ? "opacity-0 scale-90 pointer-events-none absolute" : "opacity-100 scale-100 relative"
          }`}
        >
          ...
          <span className="whitespace-nowrap">{gerandoPoster ? "Preparando o pôster..." : "Compartilhar meu ano"}</span>
        </div>

        {/* Ícones de Redes Sociais (Aparecer suavemente em grupo ao passar o mouse) */}
        <div
          className={`flex items-center gap-1.5 sm:gap-2 transition-all duration-300 ease-out ${
            hovered ? "opacity-100 scale-100 relative" : "opacity-0 scale-90 pointer-events-none absolute"
          }`}
        >
          {/* WhatsApp */}
          <button
            ...
            className="group spring-bounce flex h-8 w-8 items-center justify-center rounded-full bg-emerald-500/15 text-emerald-600 dark:bg-emerald-500/25 dark:text-emerald-400 hover:bg-emerald-500 hover:text-white transition-all duration-200 cursor-pointer shadow-xs"
          ...
          <button
            ...
            className="group spring-bounce flex h-8 w-8 items-center justify-center rounded-full bg-amora/15 text-amora dark:bg-amora/25 hover:bg-amora hover:text-papel transition-all duration-200 cursor-pointer shadow-xs disabled:opacity-50"
          ...
          <button
            type="button"
            onClick={copiarLink}
            className={`group spring-bounce flex h-8 w-8 items-center justify-center rounded-full transition-all duration-200 cursor-pointer shadow-xs ${
              copiado
          ...
          <button
            ...
            className="group spring-bounce flex h-8 w-8 items-center justify-center rounded-full bg-sky-500/15 text-sky-600 dark:bg-sky-500/25 dark:text-sky-400 hover:bg-sky-500 hover:text-white transition-all duration-200 cursor-pointer shadow-xs"
